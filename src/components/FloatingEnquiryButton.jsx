  ...
  return (
    <div className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 md:bottom-6 md:right-6 z-40">
      <a
        ...
        className="group flex items-center gap-1.5 sm:gap-2 md:gap-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-3 py-2 sm:px-3.5 sm:py-2.5 md:px-5 md:py-3 rounded-full shadow-lg transition-all duration-200"
      >
        ...
        <div className="bg-white/10 rounded-full p-0.5 sm:p-1 hidden sm:block">
